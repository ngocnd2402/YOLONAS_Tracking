...
frame_dir_path = r"datasets/MOT17/train/MOT17-14-SDP/img1"
video_out_path = os.path.join('.', 'ss-MOT17-14.mp4')
...
tracker = StrongSORT(model_weights=pathlib.Path('osnet_ain_x1_0.pt'), device='cpu')
